...
import (
	...
	httpresponse "github.com/liu04919/monitor-platform/apps/server/internal/transport/http/response"
)
...
func TestTelemetryBatchMapsRequestAndValidationErrors(t *testing.T) {
	...
	invalidEvent.Events = append([]telemetry.Event(nil), validBatch.Events...)
...
func contractBatch(t *testing.T) telemetry.Batch {
	t.Helper()
